  ...
  useEffect(() => {
    if (query.length > 2) {
      const searchResults = posts.filter(post => {
        ...
        const titleMatch = post.frontmatter.title.toLowerCase().includes(queryLower);
        const descriptionMatch = post.frontmatter.description.toLowerCase().includes(queryLower);
